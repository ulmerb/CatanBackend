...
class player:
	...
	def trade(self,userToTradeWith, curPlayer, offer, take, players, board, AiNum = -2):
		 #   while(trading):
      ...
      #       		else:
		...
		offerPassed, offer = validateTrade(offer, self)
		# takePassed, take = validateTrade(take, players[userToTradeWith])
		if offerPassed:
			return True
